 ...
 * `backend/src/types/upskilling.types.ts` and `frontend/src/types/upskilling.types.ts`
 * to keep the backend and frontend in sync.
 *
 * The backend-only `ILearningPlatformAdapter` is intentionally excluded here,
 * since the frontend never talks to learning-platform sources directly.
 *
