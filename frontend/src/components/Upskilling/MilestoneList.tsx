  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div
          className="h-2.5 w-full overflow-hidden rounded-full bg-canvas border border-gray-100"
          role="progressbar"
          ...
          return (
            ...
            >
              ...
              <div className="flex min-w-0 flex-col gap-1">
                ...
                >
                  <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-accent-blue/10 px-1.5 text-xs font-semibold text-accent-blue">
                    {milestone.sequence}
                  </span>
